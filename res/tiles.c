...
const unsigned char tileset_data[TILE_COUNT * 16] = {
    ...
    // ================================================================
    // TILE 5: STAIRS_UP — ascending staircase
    // ================================================================
    0x01,0x01,  // .......#
    0x03,0x03,  // ......##
    0x07,0x07,  // .....###
    ...
    // ================================================================
    // TILE 6: STAIRS_DOWN — descending staircase
    // ================================================================
    0xFF,0xFF,  // ########
    0x7F,0x7F,  // .#######
    0x3F,0x3F,  // ..######
    ...
    0x04,0x04,  //      #   (bone end)
    0x00,0x00,
    // Tile 22: PET_CAT — sitting cat with ears
    0x00,0x00,  // ........
    0x48,0x48,  // .#..#...  (ears)
    0x78,0x78,  // .####...  (head)
    0x58,0x58,  // .#.##...  (face)
    0x7A,0x7A,  // .####.#.  (body+tail tip)
    0x7C,0x7C,  // .#####..  (body)
    0x24,0x24,  // ..#..#..  (paws)
    0x00,0x00,  // ........
    // Tile 23: PET_DOG — Diana the dachshund (long body, big ears)
    0x00,0x00,  // ........
    0xC0,0xC0,  // ##......  (big ears)
    0xE0,0xE0,  // ###.....  (head)
    0x7F,0x7F,  // .#######  (looong body)
    0x7F,0x7F,  // .#######  (looong body)
    0x3E,0x3E,  // ..#####.  (belly)
    0x24,0x24,  // ..#..#..  (short legs)
    0x00,0x00,  // ........
    // Tile 24
    0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,
    0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,
    ...
    // Tile 128: Dagger — blade with crossguard
    0x00,0x00,  // ........
    0x02,0x02,  // ......#.  (blade tip)
    0x04,0x04,  // .....#..  (blade)
    0x0C,0x0C,  // ....##..  (blade)
    ...
    // Tile 145: Scroll 1 — rolled scroll
    0x00,0x00,  // ........
    0x3C,0x3C,  // ..####..  (top roller)
    0x5A,0x5A,  // .#.##.#.  (rolled edge)
    0x42,0x42,  // .#....#.  (parchment)
    0x42,0x42,  // .#....#.  (parchment)
    0x5A,0x5A,  // .#.##.#.  (rolled edge)
    0x3C,0x3C,  // ..####..  (bottom roller)
    0x00,0x00,  // ........
    ...
    // Tile 151: Wand 1 — wand with sparkle tip
    0x08,0x08,  // ....#...  (sparkle)
    0x14,0x14,  // ...#.#..  (sparkle)
    0x08,0x08,  // ....#...  (sparkle)
    0x04,0x04,  // .....#..  (shaft)
